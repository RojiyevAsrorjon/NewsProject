...
class RecyclerSourceSaveAdapter : ListAdapter<SourcesItem, RecyclerSourceSaveAdapter.ViewHolder>(DiffItem) {
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val image = itemView.findViewById<ImageButton>(R.id.favouriteButton)
        init {
