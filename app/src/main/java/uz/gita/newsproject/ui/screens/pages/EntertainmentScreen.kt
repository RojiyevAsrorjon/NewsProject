...
import uz.gita.newsproject.ui.viewModels.pages.EntertainmentScreenViewModel
import uz.gita.newsproject.ui.viewModels.pages.impl.EntertainmentScreenViewModelImpl

@AndroidEntryPoint
class EntertainmentScreen : Fragment(R.layout.page_general) {
    private val viewModel: EntertainmentScreenViewModel by viewModels<EntertainmentScreenViewModelImpl>()
