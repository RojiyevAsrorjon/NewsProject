...
import uz.gita.newsproject.ui.viewModels.pages.HealthScreenViewModel
import uz.gita.newsproject.ui.viewModels.pages.impl.HealthScreenViewModelImpl

@AndroidEntryPoint
class HealthScreen : Fragment(R.layout.page_general) {
    private val viewModel: HealthScreenViewModel by viewModels<HealthScreenViewModelImpl>()
