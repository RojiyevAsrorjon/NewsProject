...
import uz.gita.newsproject.ui.viewModels.pages.ScienceScreenViewModel
import uz.gita.newsproject.ui.viewModels.pages.impl.ScienceScreenViewModelImpl

@AndroidEntryPoint
class ScienceScreen : Fragment(R.layout.page_general) {
    private val viewModel: ScienceScreenViewModel by viewModels<ScienceScreenViewModelImpl>()
