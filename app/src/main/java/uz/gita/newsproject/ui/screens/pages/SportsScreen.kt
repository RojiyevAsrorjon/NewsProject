...
import uz.gita.newsproject.ui.viewModels.pages.SportScreenViewModel
import uz.gita.newsproject.ui.viewModels.pages.impl.SportScreenViewModelImpl

@AndroidEntryPoint
class SportsScreen : Fragment(R.layout.page_general) {
    private val viewModel: SportScreenViewModel by viewModels<SportScreenViewModelImpl>()
