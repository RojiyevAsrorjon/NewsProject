...
import uz.gita.newsproject.ui.viewModels.pages.TechnologyScreenViewModel
import uz.gita.newsproject.ui.viewModels.pages.impl.TechnologyScreenViewModelImpl

@AndroidEntryPoint
class TechnologyScreen : Fragment(R.layout.page_general) {
    private val viewModel: TechnologyScreenViewModel by viewModels<TechnologyScreenViewModelImpl>()
