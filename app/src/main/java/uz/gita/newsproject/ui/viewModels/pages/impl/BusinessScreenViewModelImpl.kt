...
@HiltViewModel
class BusinessScreenViewModelImpl @Inject constructor(private val useCase : SourceUseCase) : ViewModel(), BusinessScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("business").onEach {
