...
@HiltViewModel
class EntertainmentScreenViewModelImpl @Inject constructor(private val useCase : SourceUseCase) : ViewModel(), EntertainmentScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("entertainment").onEach {
