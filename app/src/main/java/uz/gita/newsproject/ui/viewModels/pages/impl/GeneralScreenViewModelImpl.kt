...
@HiltViewModel
class GeneralScreenViewModelImpl @Inject constructor(val useCase: SourceUseCase) : ViewModel(), GeneralScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("general").onEach {
