...
@HiltViewModel
class HealthScreenViewModelImpl @Inject constructor(private val useCase : SourceUseCase) : ViewModel(), HealthScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("health").onEach {
