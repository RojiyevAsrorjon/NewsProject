...
@HiltViewModel
class ScienceScreenViewModelImpl @Inject constructor(private val useCase : SourceUseCase) : ViewModel(), ScienceScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("science").onEach {
