...
@HiltViewModel
class SportScreenViewModelImpl @Inject constructor(private val useCase : SourceUseCase) : ViewModel(), SportScreenViewModel {
    ...
    init {
        if (!isConnected()) {
            ...
            useCase.getSourceNewsByCategory("sports").onEach {
